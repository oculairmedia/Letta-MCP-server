...
fn test_attach_tool_null_response() {
    ...
    assert!(result.is_ok(), "Failed to deserialize null response: {:?}", result.err());
...
fn test_attach_tool_valid_response() {
    ...
    assert!(result.is_ok(), "Failed to deserialize valid AgentState: {:?}", result.err());
...
fn test_list_agents_response() {
    ...
    assert!(result.is_ok(), "Failed to deserialize agent list: {:?}", result.err());
...
fn test_list_tools_response() {
    ...
    assert!(result.is_ok(), "Failed to deserialize tool list: {:?}", result.err());
...
fn test_archival_memory_search_response() {
    ...
    assert!(result.is_ok(), "Failed to deserialize passage list: {:?}", result.err());
